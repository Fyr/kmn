...
<style>
	...
	.page-header.navbar .top-menu .navbar-nav > li.dropdown > a.dropdown-toggle { padding: 17px 10px 9px 12px; }
	.page-header.navbar .top-menu .navbar-nav > li.dropdown > a.dropdown-toggle i {top: -1px;}
